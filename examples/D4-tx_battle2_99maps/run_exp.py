...
def main(main_args):
	...
	## Simulator
	simulator_args = {}
	simulator_args['config'] = '../../maps/D4-tx_battle2_99maps.cfg'
	...
	simulator_args['maps'] = [('MAP%.02d' % n) for n in range(1,90)]
	simulator_args['switch_maps'] = True
	#train
	...
	experiment_args['test_checkpoint'] = 'checkpoints/2017_04_08_10_47_56'
